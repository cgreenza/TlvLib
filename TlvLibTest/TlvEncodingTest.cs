...
namespace TlvLibTest
{
    ...
    public class TlvEncodingTest
    {
        ...
        [DataRow(new byte[] { 0x00, 0x01 }, 0x00u, 1, DisplayName = "0000 0000")]
        [DataRow(new byte[] { 0x7F, 0x01 }, 0x7Fu, 1, DisplayName = "0111 1111")]
        [DataRow(new byte[] { 0x26, 0x01 }, 0x26u, 1, DisplayName = "0010 0110")]
        // long form, indefinite
        [DataRow(new byte[] { 0x80, 0x01 }, null, 1, DisplayName = "1000 0000")]
        // long form
        [DataRow(new byte[] { 0x81, 0x00 }, 0x00u, 2, DisplayName = "1000 0001 0000 0000")]
        [DataRow(new byte[] { 0x81, 0x00, 0x01 }, 0x00u, 2, DisplayName = "1000 0001 0000 0000")]
        [DataRow(new byte[] { 0x81, 0x01, 0x01 }, 0x01u, 2, DisplayName = "1000 0001 0000 0001")]
        [DataRow(new byte[] { 0x81, 0xFF, 0x01 }, 0xFFu, 2, DisplayName = "1000 0001 1111 1111")]
        [DataRow(new byte[] { 0x82, 0x00, 0xFF, 0x01 }, 0xFFu, 3, DisplayName = "1000 0001 0000 0000 1111 1111")] // unnecessary length byte
        [DataRow(new byte[] { 0x82, 0xFF, 0xFF, 0x01 }, 0xFFFFu, 3, DisplayName = "1000 0010 1111 1111 1111 1111")]
        [DataRow(new byte[] { 0x83, 0xFF, 0xFF, 0xFF, 0x01 }, 0xFFFFFFu, 4, DisplayName = "1000 0011 1111 1111 1111 1111 1111 1111")]
        [DataRow(new byte[] { 0x84, 0x7F, 0xFF, 0xFF, 0xFF, 0x01 }, 0x7FFFFFFFu, 5, DisplayName = "1000 0100 0111 1111 1111 1111 1111 1111 1111 1111")] // max value for positive int
        [DataRow(new byte[] { 0x84, 0xFF, 0xFF, 0xFF, 0xFF, 0x01 }, 0xFFFFFFFFu, 5, DisplayName = "1000 0100 1111 1111 1111 1111 1111 1111 1111 1111")]
        [DataRow(new byte[] { 0x82, 0x00, 0x00, 0x01 }, 0x0000u, 3, DisplayName = "1000 0010 0000 0000 0000 0000")]
        [DataRow(new byte[] { 0x83, 0x00, 0x00, 0x00, 0x01 }, 0x000000u, 4, DisplayName = "1000 0011 0000 0000 0000 0000 0000 0000")]
        [DataRow(new byte[] { 0x84, 0x00, 0x00, 0x00, 0x00, 0x01 }, 0x00000000u, 5, DisplayName = "1000 0100 0000 0000 0000 0000 0000 0000 0000 0000")]
        [DataRow(new byte[] { 0x82, 0xAB, 0xCD, 0x01 }, 0xABCDu, 3, DisplayName = "1000 0010 1010 1011 1100 1101")]
        [DataRow(new byte[] { 0x83, 0xAB, 0xCD, 0xEF, 0x01 }, 0xABCDEFu, 4, DisplayName = "1000 0011 1010 1011 1100 1101 1110 1111")]
        [DataRow(new byte[] { 0x84, 0xAB, 0xCD, 0xEF, 0x01, 0x01 }, 0xABCDEF01u, 5, DisplayName = "1000 0100 1010 1011 1100 1101 1110 1111 0000 0001")]
        public void ReadLengthSuccess(byte[] input, uint? expectedLength, int expectedPosition)
        {
            var ms = new MemoryStream(input);
        ...
        [DataRow(0u, new byte[] { 0x00 }, DisplayName = "0")]
        [DataRow(0x7fu, new byte[] { 0x7f }, DisplayName = "7F")]
        [DataRow(0x80u, new byte[] { 0x81, 0x80 }, DisplayName = "80")]
        [DataRow(0x81u, new byte[] { 0x81, 0x81 }, DisplayName = "81")]
        [DataRow(0xffu, new byte[] { 0x81, 0xff }, DisplayName = "FF")]
        [DataRow(0x0100u, new byte[] { 0x82, 0x01, 0x00 }, DisplayName = "0100")]
        [DataRow(0xFFFFu, new byte[] { 0x82, 0xFF, 0xFF }, DisplayName = "FFFF")]
        [DataRow(0xFFFFFFu, new byte[] { 0x83, 0xFF, 0xFF, 0xFF }, DisplayName = "FFFFFF")]
        [DataRow(0xFFFFFFFFu, new byte[] { 0x84, 0xFF, 0xFF, 0xFF, 0xFF }, DisplayName = "FFFFFFFF")]
        [DataRow(0x01ABCDEFu, new byte[] { 0x84, 0x01, 0xAB, 0xCD, 0xEF }, DisplayName = "01ABCDEF")]
        public void WriteLengthSuccess(uint? length, byte[] expectedOutput)
        {
